...
export default function HeroSection() {
  ...
  <>
      ...
      <div className="absolute inset-0 -z-10 md:h-auto h-[580px]">
          <Image src="/DesktopHero.jpg" alt="hero-img" fill priority className="object-cover hidden md:block"/>
          <Image src="/MobileHero.jpg" alt="hero-img" fill priority className="object-cover block md:hidden opacity-85"/>
      </div>
