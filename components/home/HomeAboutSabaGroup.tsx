...
export default function HomeAboutSabaGroup() {
  return (
      ...
      <div className="grid md:grid-cols-2 bg-white overflow-hidden shadow-lg">
        <div className="bg-[#10562C] text-white px-5 md:px-6 py-10 md:py-20 flex flex-col items-center md:items-start justify-center rounded-2xl md:rounded-tr-none rounded-tr-2xl md:rounded-bl-2xl   rounded-bl-none rounded-br-none">
          ...
          <h2 className="block md:hidden mt-4 text-base text-center md:text-start font-bold leading-snug">
            Saba Group companies are the Pioneers in the field of Specialty
            Chemicals, Basic Chemicals and Solvents.
          </h2>
          ...
          <p className="block md:hidden mt-4 text-xs md:text-base leading-relaxed text-center">
            We have been a leading provider of Chemical for Leather industry,
            Shoe industry and Industrial chemicals across diverse sectors since
            1988
          </p>
          <p className="block md:hidden mt-4 text-xs md:text-base leading-relaxed text-center">
            Our international operations are based in Guangzhou, China, where we
            manage chemical and machinery procurement supported by our own local
            agent. We focus on trading and manufacturing high-quality chemicals
            sourced globally from Europe and South America.
          </p>
